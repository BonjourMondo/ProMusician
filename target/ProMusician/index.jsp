        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="abt-msc-content">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aperiam animi ea quia, fugiat, in dolore
                        ut vel ipsam laborum doloremque consectetur unde nam quibusdam saepe praesentium necessitatibus
                        inventore ullam distinctio?</p>
                </div>
            </div>
...
<!-- abt-music area end -->
<!-- upcooming-events area start -->
<section class="upcooming-events bg_dark ptb--100" id="event">
    <div class="container">
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <div class="upv-content">
                    <h2>Upcooming CONCERT</h2>
                    <h3>GET YOUR LIVE TICKET</h3>
                    <h4>COMING TO YOU LIVE
                        <span>NOVEMBER 27TH</span>
                    </h4>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet ad repellendus quae eaque laudantium
                        ratione asperiores minima possimus temporibus consectetur.</p>
                    <a href="#">Book Now</a>
                    <div class="count-down">
                        <div data-countdown="2018/11/17"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-trainer trainer_s_three">
                    <div class="thumb">
                        <img src="assets/images/trainer/musician/musician-img1.jpg" alt="image">
                    </div>
                    <div class="content">
                        <h4>Rosa Dietrich</h4>
                        <p>Best Music Artist</p>
                        <ul class="social">
                            <li>
                                <a href="#">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-trainer trainer_s_three">
                    <div class="thumb">
                        <img src="assets/images/trainer/musician/musician-img2.jpg" alt="image">
                    </div>
                    <div class="content">
                        <h4>Rosa Dietrich</h4>
                        <p>Best Music Artist</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-trainer trainer_s_three">
                    <div class="thumb">
                        <img src="assets/images/trainer/musician/musician-img3.jpg" alt="image">
                    </div>
                    <div class="content">
                        <h4>Rosa Dietrich</h4>
                        <p>Best Music Artist</p>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-blog">
                    ...
                    <div class="blog-thumb">
                        <img src="assets/images/blog/music-blog/music-blog-img1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog">
                    ...
                    <div class="blog-thumb">
                        <img src="assets/images/blog/music-blog/music-blog-img2.jpg" alt="">
                        <a href="blog.html" class="read-more">Read More
                            <i class="fa fa-long-arrow-right"></i>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog">
                    ...
                    <div class="blog-thumb">
                        <img src="assets/images/blog/music-blog/music-blog-img3.jpg" alt="">
                        <a href="blog.html" class="read-more">Read More
                            <i class="fa fa-long-arrow-right"></i>
                        </a>
                    </div>
...
<section class="join-club bg_black ptb--100 pt-x-none">
    <div class="container">
        <div class="msc-title section-title">
            <span>Stay Connect</span>
            <h2>With Our Music Club</h2>
        </div>
        <div class="join-form">
            <form action="#">
...
<div class="contact-area bg_dark ptb--100" >
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div id="contact">
                    <input type="text" height="300px"></div>
                </div>
            </div>
        </div>
    </div>
