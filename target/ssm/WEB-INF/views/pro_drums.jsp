...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../assets/svgDrums/css/normalize.css">
    <link rel="stylesheet" type="text/css" href="../../assets/svgDrums/fonts/font-awesome-4.3.0/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="../../assets/svgDrums/css/styles.css">
    <!--[if IE]>
...
<audio id="Crash-Audio" preload="auto">
    <source src="../../assets/svgDrums/mp3/Crash.mp3" type="audio/mp3">
</audio>
<audio id="Floor-Tom-Audio" preload="auto">
    <source src="../../assets/svgDrums/mp3/Floor-Tom.mp3" type="audio/mp3">
</audio>
<audio id="Hi-Hat-Closed-Audio" preload="auto">
    <source src="../../assets/svgDrums/mp3/Hi-Hat-Closed.mp3" type="audio/mp3">
</audio>
<audio id="Kick-Audio" preload="auto">
    <source src="../../assets/svgDrums/mp3/Kick.mp3" type="audio/mp3">
</audio>
<audio id="Small-Rack-Tom-Audio" preload="auto">
    <source src="../../assets/svgDrums/mp3/Small-Rack-Tom.mp3" type="audio/mp3">
</audio>
<audio id="Snare-Audio" preload="auto">
    <source src="../../assets/svgDrums/mp3/Snare.mp3" type="audio/mp3">
</audio>
<script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script>
<script src="../../assets/svgDrums/js/TweenMax.min.js"></script>
<script src="../../assets/svgDrums/js/script.js"></script>
</body>
</html>