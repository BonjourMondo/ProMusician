...
public class KeyTypes {
    ...
    //own setting（类）
    public static final int Metronome=51;
    public static final int Tips=52;
    public static final int Tempo=53;
    public static final int Times=54;

    public static final int Snare=55;
    public static final int FloorTom=56;
    public static final int HiHat=57;
    public static final int Kick=58;
    public static final int Crash=59;
    public static final int LeftTom=60;
    public static final int RightTom=61;

    public static final int setBeat=62;
    public static final int setBPM=63;
    public static final int setTempo=64;
